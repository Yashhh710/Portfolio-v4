        ...
        <div className="contact-grid">
          <div className="contact-left">
            ...
            <p className="contact-desc">
              Have a project in mind? Want to collaborate or just say hi? My inbox is always open. I'll get back to you as fast as possible.
            </p>
            ...
            <div className="contact-links">
              ...
              <a href="mailto:yashtambade56@gmail.com" className="contact-link-item">
                <div className="contact-link-icon">
                  <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/gmail.svg" alt="Email" width="24" height="24" style={{ filter: 'invert(1)' }} />
                </div>
              ...
              {/* GitHub Main */}
              <a href="https://github.com/yashtambade56-ux" target="_blank" rel="noreferrer" className="contact-link-item">
                <div className="contact-link-icon">
                  <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/github.svg" alt="GitHub" width="24" height="24" style={{ filter: 'invert(1)' }} />
                </div>
                <div className="contact-link-text">
              ...
              {/* GitHub 2nd */}
              <a href="https://github.com/Yashhh710" target="_blank" rel="noreferrer" className="contact-link-item">
                <div className="contact-link-icon">
                  <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/github.svg" alt="GitHub" width="24" height="24" style={{ filter: 'invert(1)' }} />
                </div>
                <div className="contact-link-text">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/yash-tambade-173508379" target="_blank" rel="noreferrer" className="contact-link-item">
                <div className="contact-link-icon">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/yashhh.710" target="_blank" rel="noreferrer" className="contact-link-item">
                <div className="contact-link-icon">
                  <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/instagram.svg" alt="Instagram" width="24" height="24" style={{ filter: 'invert(1)' }} />
                </div>
                <div className="contact-link-text">
